...
const SAMPLE_JOBS: Job[] = [
  ...
  },
  {
    ...
    location: "서울 중구",
    employment_type: "part-time",
    salary_range: "시급 11,000원",
    description: "호텔 객실 청소 및 정리. 주말 근무 가능자 우대. 외국인 환영.",
    deadline: "2026-02-18",
  ...
  },
  {
    ...
    location: "충남 천안시",
    employment_type: "full-time",
    salary_range: "연봉 4,000만원 이상",
    description: "용접 및 제관 작업. 경력자 우대. 상여금 300%. E-9 비자 가능.",
    deadline: "2026-03-15",
  ...
  },
  {
    ...
    location: "경기 이천시",
    employment_type: "contract",
    salary_range: "일급 180,000원",
    description: "물류센터 야간 상하차 작업. 셔틀 운행. 언어 무관. 단기 가능.",
    deadline: "2026-02-22",
  ...
  },
  {
    ...
    location: "서울 강남구",
    employment_type: "part-time",
    salary_range: "시급 10,500원",
    description: "주방 보조 및 설거지. 식사 제공. 평일 저녁 시간대 근무.",
    deadline: "2026-02-10",
  ...
  },
  {
    ...
    description: "농장 작물 재배, 수확 작업. 기숙사 무료 제공. 초보 환영.",
    deadline: "2026-03-05",
  ...
  },
  {
    ...
    location: "경기 수원시",
    employment_type: "full-time",
    salary_range: "월 290만원",
    description: "전자제품 조립 라인 작업. 2교대 근무. 기숙사 제공. 비자 지원.",
    deadline: "2026-02-28",
  ...
  },
  {
    ...
    location: "서울 송파구",
    employment_type: "part-time",
    salary_range: "시급 11,500원",
    description: "건물 청소 및 시설 관리. 평일 오전 근무. 장기 근무자 우대.",
    deadline: "2026-02-12",
  ...
  },
  {
    ...
    location: "대전 유성구",
    employment_type: "full-time",
    salary_range: "월 330만원",
    description: "타이어 제조 공정 작업. 3교대 근무. 기숙사 제공. 긴급 채용.",
    deadline: "2026-02-08",
  ...
  },
  {
    ...
    description: "편의점 판매 및 진열. 야간 근무 가능자 우대. F-4, F-5 비자 환영.",
    deadline: "2026-02-15",
  ...
  },
  {
    ...
    location: "경북 구미시",
    employment_type: "full-time",
    salary_range: "월 310만원",
    description: "플라스틱 사출 기계 조작 및 관리. 기술 교육 제공. 기숙사 완비.",
    deadline: "2026-03-01",
  ...
  },
  {
    ...
    location: "서울 마포구",
    employment_type: "contract",
    salary_range: "일급 120,000원",
    description: "음식 및 물품 배달. 오토바이 소지자. 탄력 근무 가능.",
    deadline: "2026-02-20",
  ...
  },
  {
    ...
    location: "충북 진천군",
    employment_type: "full-time",
    salary_range: "월 260만원",
    description: "양계장 닭 사육 및 관리. 초보 가능. 주거 시설 무료 제공.",
    deadline: "2026-02-25",
  ...
  },
  {
    ...
    location: "경기 시흥시",
    employment_type: "full-time",
    salary_range: "월 340만원",
    description: "자동차 및 기계 부품 도장 작업. 경력자 우대. 비자 지원 가능.",
    deadline: "2026-03-10",
  ...
  },
  {
    ...
    employment_type: "part-time",
    salary_range: "시급 11,000원",
    description: "카페 음료 제조 및 서빙. 주말 근무 가능자. 교육 제공.",
    deadline: "2026-02-18",
  ...
  },
  {
    ...
    location: "울산 동구",
    employment_type: "full-time",
    salary_range: "월 450만원 이상",
    description: "선박 용접 작업. 고임금. 경력 1년 이상. E-9 비자 지원 가능.",
    deadline: "2026-03-20",
  ...
  },
  {
    ...
    employment_type: "part-time",
    salary_range: "시급 12,000원",
    description: "자동차 세차 및 광택. 팁 별도 지급. 초보 환영.",
    deadline: "2026-02-14",
  ...
  },
  {
    ...
    location: "대구 서구",
    employment_type: "full-time",
    salary_range: "월 285만원",
    description: "섬유 염색 및 가공. 기숙사 제공. 장기 근무자 우대.",
    deadline: "2026-02-28",
  ...
  },
  {
    ...
    description: "창고 재고 관리 및 포장 작업. 주간 근무. 계약직 3개월.",
    deadline: "2026-02-16",
